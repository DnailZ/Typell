...
/* package tryhaskell-0.1.0.0 */
#ifndef VERSION_tryhaskell
#define VERSION_tryhaskell "0.1.0.0"
#endif /* VERSION_tryhaskell */
#ifndef MIN_VERSION_tryhaskell
#define MIN_VERSION_tryhaskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tryhaskell */
...
#define CURRENT_COMPONENT_ID "tryhaskell-0.1.0.0-inplace-tryhaskell"
